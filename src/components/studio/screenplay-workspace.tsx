...
export function ScreenplayWorkspace({
  ...
  return (
    <div className="grid h-full min-h-0 min-w-0 grid-cols-1 grid-rows-[auto_minmax(36rem,1fr)_auto] overflow-y-auto lg:grid-cols-[minmax(11rem,14rem)_minmax(0,1fr)_minmax(14rem,18rem)] lg:grid-rows-1 lg:overflow-hidden">
      <aside className="max-h-64 min-h-32 overflow-y-auto border-r border-border p-3 lg:max-h-none lg:min-h-0" aria-label="Screenplay scenes and versions">
      ...
      <section className="flex min-h-0 min-w-0 flex-col">
        <header className="shrink-0 border-b border-border px-4 py-3 sm:px-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <p className="text-[10px] tracking-[0.2em] text-subtle uppercase">03 · Screenplay</p>
      ...
      <aside className="min-h-0 overflow-y-auto border-l border-border p-4" aria-label="Screenplay profile, writing and critique">
