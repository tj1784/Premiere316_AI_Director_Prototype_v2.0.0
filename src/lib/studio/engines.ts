...
export const ENGINES: Engine[] = [
  ...
  { id: "ltx-director", name: "LTX Director", org: "WhatDreamsCost", repo: "WhatDreamsCost-ComfyUI", kind: "video" },
  ...
  { id: "index-tts", name: "IndexTTS-2.5", org: "index-tts", repo: "index-tts", kind: "voice" },
  { id: "fish-speech", name: "Fish Speech", org: "fishaudio", repo: "fish-speech", kind: "voice" },
  { id: "qwen3-tts", name: "Qwen3-TTS 1.7B VoiceDesign", org: "QwenLM", repo: "Qwen3-TTS", kind: "voice" },
  { id: "qwen3-tts-base", name: "Qwen3-TTS 1.7B Base", org: "QwenLM", repo: "Qwen3-TTS", kind: "voice" },
  ...
  { id: "yue2", name: "YuE2-3B", org: "m-a-p", repo: "YuE", kind: "music" },
  { id: "stable-audio-3", name: "Stable Audio 3 Medium", org: "Stability-AI", repo: "stable-audio-tools", kind: "music" },
  { id: "ace-step-1.5", name: "ACE-Step 1.5", org: "ace-step", repo: "ACE-Step-1.5", kind: "music" },
